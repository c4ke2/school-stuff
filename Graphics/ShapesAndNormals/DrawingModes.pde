...
enum DisplayMode {
  ...
  TEST_TRIANGLE, // single-triangle test mode
  TESSELLATE_CUBE, // cube built from triangles
  TESSELLATE_SPHERE // sphere built from triangles
}
DisplayMode displayMode = DisplayMode.KNOT;
...
Your code must implement all of these.
*/
